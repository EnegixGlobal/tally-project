...
router.get('/', async (req, res) => {
  ...
  try {
    const query = `
      SELECT 
        id, employee_id, company_id, name, father_name AS fatherName, date_of_birth AS dateOfBirth,
...
router.post('/', async (req, res) => {
  ...
  try {
    const query = `
      ...
      (employee_id, company_id, name, father_name, date_of_birth, pan, aadhar, email, phone,
