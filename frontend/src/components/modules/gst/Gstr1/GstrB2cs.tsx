...
const GstrB2cs = () => {
  ...
  const generateFullJSON = (dataToExport?: B2CSSupply[], fromDate?: string, toDate?: string) => {
    ...
    setPendingFilename(`B2CS_Report_${fDate}_to_${tDate}.json`);
  };
          ...
          >
            ...
            <div className="p-4">
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-3">
                Review the generated GSTR-1 B2C Small Supplies JSON before downloading. Click "Download" to save the file.
              </p>
