...
const Sidebar: React.FC<SidebarProps> = ({ isOpen }) => {
  ...
  const { logout, hasCompany } = useAuth();
  ...
  const menuItems = [
    ...
    { icon: <ShoppingCart size={18} />, title: "GST", path: "/app/gst" },
    { icon: <Truck size={18} />, title: "TDS", path: "/app/tds" },
    { icon: <Wallet size={18} />, title: "Income Tax", path: "/app/income-tax" },
    { icon: <BookOpen size={18} />, title: "Audit", path: "/app/audit" },
