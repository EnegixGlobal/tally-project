...
const ExtractSales: React.FC = () => {
    ...
    const exportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "Extract Sales");
        XLSX.writeFile(
            wb,
            `Extract_Sales_${new Date().toISOString().split("T")[0]}.xlsx`
        );
    };
    ...
    const handleProfitAnalysis = (sale: SalesData) => {
        ...
        const itemBreakdown = sale.itemDetails
            .map((item) => {
                ...
                return `
        <tr>
          <td style="padding: 8px; border-bottom: 1px solid #e5e7eb;">${item.itemName
                    }</td>
          <td style="padding: 8px; border-bottom: 1px solid #e5e7eb; text-align: center;">${item.quantity
                    }</td>
          ...
          <td style="padding: 8px; border-bottom: 1px solid #e5e7eb; text-align: right; color: ${itemProfit >= 0 ? "#059669" : "#dc2626"
                    };">${formatCurrency(itemProfit)}</td>
          <td style="padding: 8px; border-bottom: 1px solid #e5e7eb; text-align: right; color: ${itemProfitPercentage >= 0 ? "#059669" : "#dc2626"
      ...
      `;
        ...
        <div style="text-align: left;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 15px;">
              ...
              <div>
                ...
                costAmount
                  ...
                  Profit: <span style="color: ${grossProfit >= 0 ? "#059669" : "#dc2626"
                };">${formatCurrency(
                    grossProfit
          ...
          <div style="margin-top: 15px; padding: 10px; background-color: ${grossProfit >= 0 ? "#ecfdf5" : "#fef2f2"
        ...
        >
            ...
            >
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold">Extract Sales</h1>
                            <p className="text-sm opacity-70">
                                Extract sales data in columnar format for reporting
                            </p>
                        </div>
                    </div>
                ...
                {selectedView === "summary" && (
                    <div className="rounded-lg border">
                        ...
                        {[
                            ...
                            const financialYear = monthIndexMap[month] >= 4 ? currentYear : currentYear - 1;
                    ...
                    <div className="overflow-x-auto">
                            ...
                            <div className={`${theme === "dark" ? "bg-gray-800" : "bg-white"}`}>
                                ...
                                <div className={`p-4 border-b ${theme === "dark" ? "border-gray-700" : "border-gray-200"}`}>
                                    <div className="flex justify-between items-center mb-2">
                                        <div>
                                            <h2 className="text-lg font-bold">Extract of All Sales Vouchers</h2>
                                        </div>
                                        {extractData && (
                                ...
                                {loadingExtract ? (
                                    ...
                                    <table className="w-full">
                                        <thead className={`${theme === "dark" ? "bg-gray-700" : "bg-gray-100"}`}>
                                            <tr>
                                                ...
                                                <th className="px-4 py-3 text-right font-medium">Debit Amt.</th>
                                                <th className="px-4 py-3 text-right font-medium">Credit Amt.</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            {/* Sundry Debtors Group */}
                                            <tr className={`${theme === "dark" ? "bg-gray-800" : "bg-white"}`}>
                                                <td className="px-4 py-2 font-semibold">Sundry Debtors</td>
                                            ...
                                            <tr className={`border-t-2 ${theme === "dark" ? "border-gray-600 bg-gray-800" : "border-gray-300 bg-white"}`}>
                                                <td className="px-4 py-2 font-semibold">Sales Accounts</td>
                                                <td className="px-4 py-2"></td>
                                                <td className="px-4 py-2"></td>
                                            </tr>
                                            ...
                                            <tr className={`border-t-2 ${theme === "dark" ? "border-gray-600 bg-gray-800" : "border-gray-300 bg-white"}`}>
                                                <td className="px-4 py-2 font-semibold">Current Liabilities</td>
                                                <td className="px-4 py-2"></td>
                                                <td className="px-4 py-2"></td>
                                            </tr>
                                            ...
                                            {extractData.currentLiabilities.cgst > 0 && (
                                                <tr className={`border-t ${theme === "dark" ? "border-gray-700" : "border-gray-200"}`}>
                                                    ...
                                                    <td className="px-4 py-2 text-right font-mono">-</td>
                                                    <td className="px-4 py-2 text-right font-mono">
                                                        {formatCurrency(extractData.currentLiabilities.cgst)}
                                                    </td>
                                                </tr>
                                            )}
                                            {extractData.currentLiabilities.sgst > 0 && (
                                                <tr className={`border-t ${theme === "dark" ? "border-gray-700" : "border-gray-200"}`}>
                                                    ...
                                                    <td className="px-4 py-2 text-right font-mono">-</td>
                                                    <td className="px-4 py-2 text-right font-mono">
                                                        {formatCurrency(extractData.currentLiabilities.sgst)}
                                                    </td>
                                                </tr>
                                            )}
                                            {extractData.currentLiabilities.igst > 0 && (
                                                <tr className={`border-t ${theme === "dark" ? "border-gray-700" : "border-gray-200"}`}>
                                                    ...
                                                    <td className="px-4 py-2 text-right font-mono">-</td>
                                                    <td className="px-4 py-2 text-right font-mono">
                                                        {formatCurrency(extractData.currentLiabilities.igst)}
                                                    </td>
                                                </tr>
                                            )}
                                        </tbody>
                                    ...
                                    <div className="p-8 text-center">
                                        <p className="opacity-70">Click on a month to view extract data</p>
                                    </div>
                                )}
                            </div>
                        )}
                                    ...
                                    <tbody>
                                        {filteredSalesData.map((sale) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-3 text-center">
                                                    <span
                                                        className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${sale.status === "Paid"
                        ...
                        {selectedView === "billwiseprofit" && (
                            <div className="space-y-4">
                                        ...
                                        {filteredSalesData.map((sale) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <td className="px-4 py-3 text-right">
                                                        <div
                                                            className={`font-mono font-bold ${grossProfit >= 0
                                                                    ? "text-green-600"
                                                                    : "text-red-600"
                                                                }`}
                                                        >
                                                    ...
                                                    <td className="px-4 py-3 text-right">
                                                        <div
                                                            className={`font-mono font-bold text-lg ${profitPercentage >= 0
                                                                    ? "text-green-600"
                                                                    : "text-red-600"
                                                                }`}
                                                        >
                                                    ...
                                                    <td className="px-4 py-3 text-center">
                                                        <span
                                                            className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${profitPercentage >= 25
                                                                    ? "bg-green-100 text-green-800"
                                                                    : profitPercentage >= 15
                                                                        ? "bg-yellow-100 text-yellow-800"
                                                                        : profitPercentage >= 0
                                ...
                                <div
                                    className={`p-6 rounded-lg ${theme === "dark" ? "bg-gray-700" : "bg-white shadow"
                                        }`}
                                >
                                    ...
                                    <div
                                        className={`h-64 flex items-center justify-center border-2 border-dashed rounded-lg ${theme === "dark" ? "border-gray-600" : "border-gray-300"
                                            }`}
                                    >
            ...
            {showDetailModal && selectedSale && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div
                        className={`max-w-4xl w-full max-h-[90vh] overflow-y-auto rounded-lg ${theme === "dark" ? "bg-gray-800" : "bg-white"
                            }`}
                    >
                        <div
                        ...
                        >
                            <div className="flex items-center justify-between">
                                <h2 className="text-xl font-bold">Extract Sales Details</h2>
                                <button
                                    onClick={closeModal}
                                    className={`p-2 rounded-md ${theme === "dark" ? "hover:bg-gray-700" : "hover:bg-gray-200"
                                        }`}
                        ...
                        <div className="p-6">
                            ...
                            <div className="mb-6">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    <div
                                        className={`p-3 rounded ${theme === "dark" ? "bg-gray-700" : "bg-gray-50"
                                            }`}
                                    >
                                ...
                                <div
                                    className={`mt-4 p-4 rounded border-2 ${theme === "dark"
                            ...
                            {selectedSale.itemDetails.length > 0 && (
                                <div className="mb-6">
                                    ...
                                    <div className="overflow-x-auto">
                                        <table
                                            className={`w-full border rounded ${theme === "dark" ? "border-gray-600" : "border-gray-300"
                                                }`}
                                        >
                                            <thead
                                                className={`${theme === "dark" ? "bg-gray-700" : "bg-gray-100"
