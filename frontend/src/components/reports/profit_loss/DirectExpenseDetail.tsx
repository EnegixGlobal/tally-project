...
const DirectExpenseDetail: React.FC = () => {
  ...
  return (
    <div className="pt-[56px] px-4">
      ...
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold">Direct Expense Account</h1>
      ...
      {!selectedMonth && (
        <div>
          ...
          >
            <div className="text-lg font-semibold">Direct Expense Account</div>
...
export default DirectExpenseDetail;
