...
const IndirectIncomeDetail: React.FC = () => {
    ...
    return (
        <div className="pt-[56px] px-4">
            ...
            <div className="flex items-center mb-6">
                ...
                <h1 className="text-2xl font-bold">Indirect Income Account</h1>
            ...
            {!selectedMonth && (
                <div>
                    ...
                    >
                        <div className="text-lg font-semibold">Indirect Income Account</div>
                ...
                <div className="mt-4">
                    ...
                    {selectedMonthData.length === 0 ? (
                        ...
                        <>
                            ...
                            >
                                <div className="col-span-5 px-3 py-2 text-right">Total :</div>
                                <div className="px-3 py-2 text-right font-mono">
...
export default IndirectIncomeDetail;
