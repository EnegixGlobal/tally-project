  ...
  useEffect(() => {
    ...
    const fetchDetails = async () => {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_API_URL}/api/outstanding-receivables/${ledgerId}?company_id=${company_id}&owner_type=${owner_type}&owner_id=${owner_id}`
      );
