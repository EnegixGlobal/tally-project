  ...
  useEffect(() => {
    const fetchOutstandingData = async () => {
      ...
      try {
        ...
        const url = `${apiUrl}/api/outstanding-payables?company_id=${companyId}&owner_type=${ownerType}&owner_id=${ownerId}&group_id=${currentGroup.id}`;
